          ...
          <div className="about-content reveal">
            ...
            <div className="about-quick-facts">
              <div className="quick-fact">
                ...
                <span className="fact-value">Kerala, India</span>
              </div>
              <div className="quick-fact">
                <span className="fact-label">🎓 Education</span>
                <span className="fact-value">Self-Taught MERN Stack Developer</span>
              </div>
              <div className="quick-fact">
            ...
            <div className="about-journey glass-card">
              ...
              <div className="journey-timeline">
                <div className="journey-item">
                  ...
                  <span className="journey-event">Self-Taught Mern Stack developer</span>
                </div>
